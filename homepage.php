        ...
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-12">
            ...
            <div class="flex flex-col items-center justify-center space-y-8 py-12">
                ...
                <div class="profile-container relative group">
                    ...
                    <!-- Upload/Change Picture Button (always visible) -->
                    <button onclick="openProfilePictureModal()" class="absolute bottom-0 right-0 w-10 h-10 bg-sky-600 hover:bg-sky-700 rounded-full flex items-center justify-center shadow-lg border-2 border-white transition-all duration-200 hover:scale-110" title="Upload Photo">
